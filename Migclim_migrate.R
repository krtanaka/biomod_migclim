MigClim.migrate_KRT = function (iniDist = "InitialDist", 
                                hsMap = "HSmap", 
                                rcThreshold = 0, 
                                envChgSteps = 1, 
                                dispSteps = 1, 
  ...
  # simulName = paste(barrierType, dispKernel, iniMatAge, lddFreq, lddMinDist, lddMaxDist, sep = "_") 
  simulName = paste(barrierType, dispKernel, iniMatAge, sep = "_") 
