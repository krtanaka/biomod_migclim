...
# Prepare Biomod input data for lobster -----------------------------------------------
...
# Prepare Biomod input data for scallop -----------------------------------------------
load(paste0(dir, "Google Drive/R/Biomod/scallop/scallop_survey_data_spring_fall_combined_1984-2016.RData")) #load survey data
...
source(paste0(dir, "Google Drive/Research/Charlie/SST_Skill/BIOMOD_tuning_KRT.R"))
...
save(Biomod.tuning, file = "Biomod_Tuning_Results.RData")


# load tuned results ------------------------------------------------------
setwd(paste0(dir, "Google Drive/R/Biomod/", sp))
load("Biomod_Tuning_Results.RData")
...
for (i in 1:length(sp)) {
  ...
  # setwd(paste0("/Users/kisei/Google Drive/R/Biomod/", sp[[i]]))
  setwd(paste0("/Users/kisei/Desktop/", sp[[i]]))
  ...
  tss_roc
  # write_csv(tss_roc, paste0("/Users/Kisei/Google Drive/Research/Manuscripts/Biomod/", sp[[i]], "_ROC_TSS.csv"))
  ...
  # jpeg(paste0("/Users/Kisei/Desktop/model_evaluation_legend.jpg"), res = 500, height = 5, width = 1, units = "in")
  ...
  legend("bottomright", "Ensemble Prediction", bty = "n", cex = 1.4)
...
setwd(paste0(dir, "/Desktop/", sp)); load("Biomod_Results.RData"); load("final_sdms.RData")
...
for (k in 1:length(season)){
  ...
  if (op == "default") {
    ...
    write_csv(POS1, paste0("Biomod_1_80_", season, "_with_default_options.csv"), col_names = T)
    
  }else{
    
    write_csv(POS1, paste0("Biomod_1_80_", season, ".csv"), col_names = T)
  }
